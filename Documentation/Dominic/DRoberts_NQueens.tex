...
\hypersetup{linkcolor=blue, pdftitle={Solving the NQueens problem with Genetic Algorithms seeded by lower dimension results}, pdfauthor={Dominic Roberts}, pdfsubject={Genetic Algorithmms N-Queens problem -- May 2019}, pdfkeywords={software quality, software testing, mutation testing, genetic algorithms} }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\author{
\IEEEauthorblockN{D. Roberts}
\IEEEauthorblockA{\textit{MSc. Computation Intelligence} \\
	\textit{De Montfort University}\\
	\textit{Leicester, UK} \\
	\textit{P17201056@my365.dmu.ac.uk}}
}
...
\bibitem{Deadlock} M.M. Tanik, (1978) A graph model for deadlock prevention, Ph.D. Thesis, Texas A and M University, 1978

\bibitem{SIMD} M. M. Tanik, (1994) Parallel memory Allocation and Data Alignment in SIMD Machines, Parallel Algorithms and Applications, 1994
...
\bibitem{Quantum} V. Torggler, P. Aumann, H. Ritsch, W. Lechner (2018) A Quantum N-Queens Solver arXiv:1803.00735 

\bibitem{Adaptive} U. Sarkar, S. Nag (2018) An Adaptive Genetic Algorithm for Solving NQueens Problem CoRR, abs/1802.02006.

\bibitem{Polynomial} R. Sosic, J. Gu (1990) A Polynomial Time Algorithm for the N-Queens Problem. SIGART Bulletin, Vol. 1, 3, pp. 7-11

\bibitem{Performance} V. Thada, S. Dhaka (2014) Performance Analysis of N-Queen Problem using Backtracking and Genetic Algorithm Techniques. International journal of Computer Applications Vol 102, No. 7

\bibitem{Backtracking} Chakiat. Abhijith, Sudhakaran. Akhil, A. Abhinav, Venkatesh, Pallavi. (2017). A Novel Double Backtracking Approach to the N-Queens Problem in Three Dimensions. International Journal of Computer Applications. 169. 1-5. 10.5120/ijca2017914749. 

\bibitem{Guldal} S. Güldal, V. Baugh and S. Allehaibi, "N-Queens solving algorithm by sets and backtracking," SoutheastCon 2016, Norfolk, VA, 2016, pp. 1-8.
